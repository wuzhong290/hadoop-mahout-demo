...
public final class RecommenderJob extends AbstractJob {
    ...
    public int run(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        Path usersFile = parsedArgs.get("--usersFile") == null ? inputFile : new Path(parsedArgs.get("--usersFile").get(0));

        String recommendClassName = parsedArgs.get("--recommenderClassName").get(0);
        int recommendationsPerUser = Integer.parseInt(parsedArgs.get("--numRecommendations").get(0));
